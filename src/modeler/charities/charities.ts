interface GiveDirectlyMetrics {
  name: string, grantSizeUsd: number, householdSize: number,
...
export const giveDirectly2021: GiveDirectlyMetrics =
    {
      ...
      grantInvestmentReturnAnnual: 0.10,

    }

function giveDirectlyInvestmentReturn(metrics: GiveDirectlyMetrics, amount: number) {
  ...
  const investmentReturns = investedAmount * metrics.grantInvestmentReturnAnnual;
